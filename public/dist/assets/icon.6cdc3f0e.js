import{q as h,r as o,s as e,t as p,v as i,w as m,x as n,y as d,z as F,A as f,C as E,D as v,E as M}from"./index.0c64b17e.js";import{g as u,h as I,j as B,k as H}from"./index.fd473fe5.js";import{a7 as t,bH as V,bI as k}from"./index.61f93fd1.js";import{I as x}from"./Layout.f0c500e2.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:x,db:u,md:F,epub:I,iso:B,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:A,url:H},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return k;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,V(a.name));export{l as O,S as g};
